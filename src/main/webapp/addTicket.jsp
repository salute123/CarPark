        ...
        <div class="form-group row">
            <div class="time">
                <div class="input-group">
                    <input type="text" class="form-control form_datetime" id="ktime" name="ktime"  placeholder="开始时间">
                    <span class="input-group-addon" id="Span2"><span class="glyphicon glyphicon-time" aria-hidden="true"></span></span>
                    <input type="text" class="form-control form_datetime" id="jtime" name="jtime"  placeholder="结束时间">
